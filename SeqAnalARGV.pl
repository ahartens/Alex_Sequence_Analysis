...
# Label the columns for later printing 
$file_names[0]= "File";
$headers[0] = "Header";
$id[0] = "ID";
...
# Reads through files in a directory
$file_count= 0;

@files = <$ARGV[0]/*>; # Directory name placed here
foreach $file (@files) {
	$file_name = $file;
...
# Print array of data in Terminal
my $x = 0;
...
# Appends information to CSV file 'output.csv' 
my $x = 0;
for ($x= 0; $x<$file_count+1; $x++){
...
# Identifies chain, locates insert, checks for frame shift
sub insert_id {
